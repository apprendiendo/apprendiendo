...
<div class="form-group">
    ...
    {!! Form::select('grade',['' => ''],null,['class' => 'form-control input-sm']) !!}
</div>
<div class="form-group">
    {!! Form::label('subject','Materia:')!!}
    {!! Form::select('subject',['' => ''],null,['class' => 'form-control input-sm']) !!}
...
<div class="form-group">
    ...
    {!! Form::select('device',['0'=>'- Selecciona un dispositivo -','Ipad' => 'Ipad','Tablet' => 'Tablet'],null,['class' => 'form-control']) !!}
</div>
<div class="form-group">
...
<div class="form-group">
    {!! Form::submit($submitBtnTxt,['class' => 'btn btn-primary form-control', 'id' => 'create_btn']) !!}
</div>