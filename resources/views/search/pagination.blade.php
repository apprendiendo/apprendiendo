                    ...
                    @foreach($Suggestions as $suggestion)
                        <div id="postlist">
                            <div class="panel">
                                ...
                                <div class="panel-footer"><span class="label label-default">Por: {!! \App\User::find($suggestion->user_id)->username !!}</span><span class="label label-success pull-right">{!! link_to('results/' .$suggestion->id ,'Ver',null) !!}</span></div>
